								...
								<figure class='card card-product'>
									<form method="POST">
										...
										<figcaption class='info-wrap'>
											<a href='#' class='title link-produk'>
												<?=$data['judul_buku']?>
											</a>
				...
				<div class="col-md-4">
									...
									<tr>
										<td>
											<figure class="media">
												<div class="img-wrap"><img
														src="../admin/uploads/<?=$product['gambar']?>"
										...
										<td class="text-center">
											<form method="POST">
												<div class="m-btn-group m-btn-group--pill btn-group mr-2" role="group"
													aria-label="...">
													<input type="hidden" name="apaan"
														value="<?=$product['kode_barang']?>">
													<input type="hidden" name="harg"
														value="<?=$product['harga_jual']?>">
													<button type="button" onclick="kurang(<?= $key?>)"
														class="m-btn btn btn-default"><i
															class="fa fa-minus"></i></button>
													<input type="number" min="1" value="<?=$product['qty']?>" name="kok"
														class="byks"
														style="width: 37.63px;border-color: #F2F3F8;height: 35.75px;font-size: 5">
													<button type="button" onclick="tambah(<?= $key?>)"
														class="m-btn btn btn-default"
														style="width: 37.63px;border-color: #F2F3F8;height: 35.75px;"><i
															class="fa fa-plus"></i></button>
													<button type="submit" name="update"
														class="m-btn btn btn-default ml-2"
														style="width: 37.63px;border-color: #F2F3F8;height: 35.75px;"><i
										...
										<td>
											<div class="price-wrap">
												<var class="price">
													<?php echo $total=$product['harga_jual'] * $product['qty'];?>
												</var>
											</div> <!-- price-wrap .// -->
										</td>
										<form method="post">
											...
											<td class="text-right">
												<button name="delete" type="submit" class="btn btn-outline-danger"> <i
					...
					<div class="box">
						<dl class="dlist-align">
							<dt>Total: </dt>
							<dd class="text-right h4 b" id="tl" class="total_price">
								<?= $grand_total?>
							</dd>
						</dl>
						<dl class="dlist-align">
						...
						<div class="row mt-2">
							...
							<div class="col-md-6">
								<a href="../invoice/invoice.php" target="_blank"
									class="btn  btn-primary btn-lg btn-block" id="checkout-btn"><i
